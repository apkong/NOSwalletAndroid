package co.nos.noswallet.analytics;
...
public class AnalyticsEvents {
    ...
    public static final String ERROR_PARSING_QR_CODE = "SocketClosed Parsing QR Code";
    public static final String ERROR_DECODING_CMCBTC_PRICE_DATA = "SocketClosed decoding CoinMarketCap BTC price data";
    public static final String ERROR_DECODING_CMCNANO_PRICE_DATA = "SocketClosed decoding CoinMarketCap Nano price data";
    public static final String ERROR_GETTING_CMCBTC_PRICE_DATA = "SocketClosed getting CoinMarketCap BTC price data";
    public static final String ERROR_GETTING_CMCNANO_PRICE_DATA = "SocketClosed getting CoinMarketCap Nano price data";
    public static final String ERROR_GETTING_EXCHANGE_PRICE_DATA = "SocketClosed getting exchange price data";
    public static final String ERROR_GENERATING_WORK_FOR_SENDING = "SocketClosed Generating Work for Sending";
    public static final String ERROR_UNWRAPPING_LOCAL_CURRENCY_TEXT = "SocketClosed unwrapping Local Currency text";
    ...
    public static final String SEND_AUTH_ERROR = "SocketClosed with Send Authentication";
    ...
    public static final String SOCKET_ERROR_HOME = "socket SocketClosed in HomeVM";
    ...
    // LocalCurrencyPair
    public static final String ERROR_FORMATTING_LOCAL_CURRENCY_STRING_TO_DOUBLE = "SocketClosed formatting Local Currency String to Double";
    public static final String ERROR_IN_LOCAL_CURRENCY_DECODE_FUNCTION = "SocketClosed in LocalCurrencyPair.decode function";
    public static final String UNABLE_TO_GET_LOCAL_CURRENCY_PAIR_BTC_PRICE = "Local Currency Pair SocketClosed: unable to get Bitcoin price";

    public static final String ERROR_FORMATTING_NANO_STRING_TO_DOUBLE = "SocketClosed formatting Nano Price Pair String to Double";
    public static final String ERROR_IN_NANO_DECODE_FUNCTION = "SocketClosed in NanoPricePair.decode function";
    public static final String UNABLE_TO_GET_NANO_PRICE = "Nano Price Pair SocketClosed: unable to get price";
