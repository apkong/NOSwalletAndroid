...
public class MaterialSpinner extends AppCompatSpinner implements ValueAnimator.AnimatorUpdateListener {
    ...
    private int startSpinnerPadding;
    ...
    //Default hint views
    private Integer dropDownHintView;
    private Integer hintView;
    ...
    private void initAttributes(Context context, AttributeSet attrs) {
        ...
        int defaultErrorColor = context.getResources().getColor(R.color.ms_error_color);
        ...
        disabledColor = context.getResources().getColor(R.color.ms_disabled_color);
        ...
        thicknessError = array.getDimension(R.styleable.MaterialSpinner_ms_thickness_error, 1);
        ...
        hintView = array.getResourceId(R.styleable.MaterialSpinner_ms_hintView, android.R.layout.simple_spinner_item);
        dropDownHintView = array.getResourceId(R.styleable.MaterialSpinner_ms_dropDownHintView, android.R.layout.simple_spinner_dropdown_item);
        ...
        final CharSequence[] entries = array.getTextArray(R.styleable.MaterialSpinner_ms_entries);

        if (entries != null) {
            int entryView = array.getResourceId(R.styleable.MaterialSpinner_ms_entryView, android.R.layout.simple_spinner_item);
            int dropDownEntryView = array.getResourceId(R.styleable.MaterialSpinner_ms_dropDownEntryView, android.R.layout.simple_spinner_item);
            final ArrayAdapter<CharSequence> adapter = new ArrayAdapter<>(context, entryView, entries);
    ...
    private void initPaintObjects() {
        ...
        int labelTextSize = getResources().getDimensionPixelSize(R.dimen.ms_error_label_text_size);
    ...
    private void updateBottomPadding() {
        ...
        extraPaddingBottom = underlineTopSpacing + (error != null ? underlineBottomSpacing : 0);
        if (enableErrorLabel) {
    ...
    private void initDimensions() {
        underlineTopSpacing = getResources().getDimensionPixelSize(R.dimen.ms_underline_top_spacing);
        underlineBottomSpacing = getResources().getDimensionPixelSize(R.dimen.ms_underline_bottom_spacing);
        floatingLabelTopSpacing = getResources().getDimensionPixelSize(R.dimen.ms_floating_label_top_spacing);
        floatingLabelBottomSpacing = getResources().getDimensionPixelSize(R.dimen.ms_floating_label_bottom_spacing);
        startSpinnerPadding = alignLabels ? getResources().getDimensionPixelSize(R.dimen.ms_start_spinner_padding) : 0;
        endSpinnerPadding = getResources().getDimensionPixelSize(R.dimen.ms_arrow_padding);
        floatingLabelInsideSpacing = getResources().getDimensionPixelSize(R.dimen.ms_floating_label_inside_spacing);
        errorLabelSpacing = (int) getResources().getDimension(R.dimen.ms_error_label_spacing);
        minContentHeight = (int) getResources().getDimension(R.dimen.ms_min_content_height);
    }
    ...
    private boolean needScrollingAnimation() {
        if (error != null) {
            float screenWidth = getWidth() - startSpinnerPadding - endSpinnerPadding;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (error != null && enableErrorLabel) {
            ...
            if (multiline) {
                ...
                //scrolling
                canvas.drawText(error.toString(), startX + startSpinnerPadding - errorLabelPosX, startYErrorLabel, textPaint);
                if (errorLabelPosX > 0) {
                    canvas.save();
        ...
        if ((hint != null || floatingLabelText != null) && enableFloatingLabel) {
            ...
            if (isRtl) {
                canvas.drawText(textToDraw, getWidth() - startSpinnerPadding - textPaint.measureText(textToDraw), startYFloatingLabel, textPaint);
            } else {
                canvas.drawText(textToDraw, startX + startSpinnerPadding, startYFloatingLabel, textPaint);
            }
        }

        drawSelector(canvas, getWidth() - startSpinnerPadding - endSpinnerPadding, getPaddingTop() + dpToPx(8));
    ...
    private class HintAdapter extends BaseAdapter {
        ...
        private View getHintView(final View convertView, final ViewGroup parent, final boolean isDropDownView) {
            ...
            final int resid = isDropDownView ? dropDownHintView : hintView;
